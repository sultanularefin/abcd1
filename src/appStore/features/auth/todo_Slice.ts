...
const update_current_new_note_2 = (
  ...
  let driver_new_todo_TEMP = state.new_to_do;
  ...
  state.new_to_do = driver_new_todo_TEMP;
};
...
const update_edited_notes_to_store=(
  ...
  state.items = old_todo_items_temp[editing_item_index]=editing_note_item;// .concat(editing_note_item);
